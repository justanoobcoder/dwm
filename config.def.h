...
static const char *const autostart[] = {
        //"dwm-msg", "subscribe", "tag_change_event", "layout_change_event", ">", "/tmp/dwm.log", "&", NULL,
	"eww", "daemon", NULL,
	"eww", "open", "bar", NULL,
	NULL /* terminate */
};
...
static const Key keys[] = {
	...
	{ 0,            MODKEY|Mod4Mask,              XK_h,      incrgaps,       {.i = +1 } },
	{ 0,            MODKEY|Mod4Mask,              XK_l,      incrgaps,       {.i = -1 } },
	{ 0,            MODKEY|Mod4Mask|ShiftMask,    XK_h,      incrogaps,      {.i = +1 } },
	{ 0,            MODKEY|Mod4Mask|ShiftMask,    XK_l,      incrogaps,      {.i = -1 } },
	{ 0,            MODKEY|Mod4Mask|ControlMask,  XK_h,      incrigaps,      {.i = +1 } },
	{ 0,            MODKEY|Mod4Mask|ControlMask,  XK_l,      incrigaps,      {.i = -1 } },
	...
	{ 0,            MODKEY|Mod4Mask,              XK_y,      incrohgaps,     {.i = +1 } },
	{ 0,            MODKEY|Mod4Mask,              XK_o,      incrohgaps,     {.i = -1 } },
